...
def ik_service_client():
    ...
    pose_stamped.pose.position.x = float(input('Please enter an x position for the end effector: '))
    pose_stamped.pose.position.y = float(input('Please enter an y position for the end effector: '))
    pose_stamped.pose.position.z = float(input('Please enter an z position for the end effector: '))
